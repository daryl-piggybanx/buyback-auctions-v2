...
export function DuplicateUsersManager() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">User Management - Duplicate Users</h2>
      ...
      {duplicateUsers.length === 0 ? (
        ...
        <div className="space-y-4">
          ...
          {duplicateUsers.map((duplicate) => (
            <div key={duplicate.email} className="border border-gray-200 rounded-lg p-4">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900">{duplicate.email}</h3>
                  <p className="text-sm text-gray-500 mb-2">{duplicate.count} duplicate accounts</p>
